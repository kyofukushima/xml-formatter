...
- このListがSubitem9要素に変換される
- 1つ目のColumnの内容（例：「４．３．２」）がSubitem9Titleに配置される
- 2つ目のColumnの内容がSubitem9Sentenceに配置される
...
- Subitem2要素内のColumnなしListは、前のSubitem9要素（ColumnありListから変換されたSubitem9）にList要素として追加されることを確認
