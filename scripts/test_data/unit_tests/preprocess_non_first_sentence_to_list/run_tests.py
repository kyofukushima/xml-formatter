...
"""
preprocess_non_first_sentence_to_list.py の単体テスト実行スクリプト
"""
...
def run_test(test_dir):
    ...
    # preprocess_non_first_sentence_to_list.py を実行
    script_path = Path(__file__).resolve().parent.parent.parent.parent / "preprocess_non_first_sentence_to_list.py"
...
def main():
    ...
    print("preprocess_non_first_sentence_to_list.py 単体テスト実行")
    print("=" * 50)
