...
- このListがSubitem8要素に変換される
- 1つ目のColumnの内容（例：「４．３．２」）がSubitem8Titleに配置される
- 2つ目のColumnの内容がSubitem8Sentenceに配置される
...
- Subitem2要素内のColumnなしListは、前のSubitem8要素（ColumnありListから変換されたSubitem8）にList要素として追加されることを確認
