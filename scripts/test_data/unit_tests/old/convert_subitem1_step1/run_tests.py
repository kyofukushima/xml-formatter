...
"""
convert_subitem1_step1.py の単体テスト実行スクリプト
"""
...
def run_test(test_dir):
    ...
    # convert_subitem1_step1.py を実行（出力を標準出力にリダイレクト）
    script_path = Path("/Users/fukushima/Documents/xml_anken/education_xml/scripts/convert_subitem1_step1.py")
...
def main():
    ...
    print("convert_subitem1_step1.py 単体テスト実行")
    print("=" * 50)
