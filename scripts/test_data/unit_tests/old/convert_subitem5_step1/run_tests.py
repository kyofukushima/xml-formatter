...
"""
convert_subitem5_step1.py の単体テスト実行スクリプト
"""
...
def run_test(test_dir):
    ...
    # convert_subitem5_step1.py を実行（出力を標準出力にリダイレクト）
    script_path = Path("/Users/fukushima/Documents/xml_anken/education_xml/scripts/convert_subitem5_step1.py")
...
def main():
    ...
    print("convert_subitem5_step1.py 単体テスト実行")
    print("=" * 50)

    # テストケースの収集
    test_dirs = []
    for item in test_root.iterdir():
        if item.is_dir() and item.name.startswith(('01_', '02_', '03_', '04_', '05_', '06_', '07_')):
