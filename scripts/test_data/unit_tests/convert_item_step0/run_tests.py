...
"""
convert_item_step0.py の単体テスト実行スクリプト
"""
...
def run_test(test_dir):
    ...
    # convert_item_step0.py を実行（出力を標準出力にリダイレクト）
    # スクリプトのパスを現在のワークスペースに合わせて設定
    script_dir = Path(__file__).parent.parent.parent.parent
    script_path = script_dir / "convert_item_step0.py"
...
def main():
    ...
    print("convert_item_step0.py 単体テスト実行")
    print("=" * 50)

    # テストケースの収集
    test_dirs = []
    for item in test_root.iterdir():
        if item.is_dir() and item.name.startswith(('01_', '02_', '03_', '04_', '05_', '06_', '07_', '08_', '09_', '10_', '11_', '12_', '13_', '14_', '15_','16_','17_','18_','19_','20_','21_','22_','23_','24_','25_','26_','27_','28_','29_','30_','31_','32_','33_','34_','35_','36_','37_','38_','39_','40_','41_','42_','43_')):
