...
- このListがSubitem6要素に変換される
- 1つ目のColumnの内容（例：「４．３．２」）がSubitem6Titleに配置される
- 2つ目のColumnの内容がSubitem6Sentenceに配置される
...
- Subitem2要素内のColumnなしListは、前のSubitem6要素（ColumnありListから変換されたSubitem6）にList要素として追加されることを確認
