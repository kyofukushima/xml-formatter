...
- このListがSubitem10要素に変換される
- 1つ目のColumnの内容（例：「４．３．２」）がSubitem10Titleに配置される
- 2つ目のColumnの内容がSubitem10Sentenceに配置される
...
- Subitem2要素内のColumnなしListは、前のSubitem10要素（ColumnありListから変換されたSubitem10）にList要素として追加されることを確認
