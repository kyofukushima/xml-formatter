...
"""
convert_paragraph_step3.py の単体テスト実行スクリプト
"""
...
def run_test(test_dir):
    ...
    # convert_paragraph_step3.py を実行
    script_dir = Path(__file__).parent.parent.parent.parent
    script_path = script_dir / "convert_paragraph_step3.py"
...
def main():
    ...
    print("convert_paragraph_step3.py 単体テスト実行")
    print("=" * 50)
