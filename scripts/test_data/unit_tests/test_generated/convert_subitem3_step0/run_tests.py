...
"""
convert_subitem3_step0.py の単体テスト実行スクリプト
"""
...
def run_test(test_dir):
    ...
    # test_generated/convert_subitem3_step0/run_tests.py から scripts/ へのパス
    script_dir = Path(__file__).parent.parent.parent.parent.parent
    script_path = script_dir / "convert_subitem3_step0.py"
...
def main():
    ...
    print("convert_subitem3_step0.py 単体テスト実行")
    print("=" * 50)
