...
"""
convert_subitem9_step0.py の単体テスト実行スクリプト
"""
...
def run_test(test_dir):
    ...
    # convert_subitem9_step0.py を実行（出力を標準出力にリダイレクト）
    # スクリプトのパスを現在のワークスペースに合わせて設定
    # test_generated/convert_subitem9_step0/run_tests.py から scripts/ へのパス
    script_dir = Path(__file__).parent.parent.parent.parent.parent
    script_path = script_dir / "convert_subitem9_step0.py"
...
def main():
    ...
    print("convert_subitem9_step0.py 単体テスト実行")
    print("=" * 50)
