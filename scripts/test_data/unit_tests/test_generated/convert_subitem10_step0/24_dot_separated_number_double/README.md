...
- ColumnありList要素で、1つ目のColumnに「４．３．２」「４．３．３」などのドット2つで区切られた数字のラベルがある
- このListがItem要素に変換される
- 1つ目のColumnの内容（例：「４．３．２」）がItemTitleに配置される
...
変換統計に `converted_labeled_list_to_item: 2` がカウントされるはずです（`４．３．２`、`４．３．３`の2つ）。
