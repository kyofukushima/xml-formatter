...
def run_test(test_dir):
    ...
    script_path = Path("/Users/fukushima/Documents/xml_anken/education_xml/scripts/convert_subitem2_step0.py")
...
def main():
    ...
    for item in test_root.iterdir():
        if item.is_dir() and item.name.startswith(('01_', '02_', '03_', '04_', '05_', '06_', '12_', '13_', '14_', '15_','16_','17_','18_')):
